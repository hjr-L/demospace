    ...
    lifetimes: {
        attached() {
            this.setData({
                ...
                navInnerPaddingRight:  app.globalData.navInnerPaddingRight,
                navLeftWidth: app.globalData.navLeftWidth,
            ...
            //             this.eshopStore.store.navTop = this.globalData.navTop = navTop
            //         } else {
